...
#define CY_BLE_NSTIM_READFIRST_CHAR_INDEX   (0x00u) /* Index of ReadFirst characteristic */
#define CY_BLE_NSTIM_READFIRST_CUSTOM_DESCRIPTOR_DESC_INDEX   (0x00u) /* Index of Custom Descriptor descriptor */
#define CY_BLE_NSTIM_WRITEVAL_CHAR_INDEX   (0x01u) /* Index of WriteVal characteristic */
#define CY_BLE_NSTIM_WRITEVAL_CUSTOM_DESCRIPTOR_DESC_INDEX   (0x00u) /* Index of Custom Descriptor descriptor */
#define CY_BLE_NSTIM_READSECOND_CHAR_INDEX   (0x02u) /* Index of ReadSecond characteristic */
#define CY_BLE_NSTIM_READSECOND_CUSTOM_DESCRIPTOR_DESC_INDEX   (0x00u) /* Index of Custom Descriptor descriptor */
#define CY_BLE_NSTIM_NOTIFONE_CHAR_INDEX   (0x03u) /* Index of NotifOne characteristic */
#define CY_BLE_NSTIM_NOTIFONE_CUSTOM_DESCRIPTOR_DESC_INDEX   (0x00u) /* Index of Custom Descriptor descriptor */
#define CY_BLE_NSTIM_NOTIFONE_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_INDEX   (0x01u) /* Index of Client Characteristic Configuration descriptor */


#define CY_BLE_NSTIM_SERVICE_HANDLE   (0x0010u) /* Handle of NSTIM service */
#define CY_BLE_NSTIM_READFIRST_DECL_HANDLE   (0x0011u) /* Handle of ReadFirst characteristic declaration */
#define CY_BLE_NSTIM_READFIRST_CHAR_HANDLE   (0x0012u) /* Handle of ReadFirst characteristic */
#define CY_BLE_NSTIM_READFIRST_CUSTOM_DESCRIPTOR_DESC_HANDLE   (0x0013u) /* Handle of Custom Descriptor descriptor */
#define CY_BLE_NSTIM_WRITEVAL_DECL_HANDLE   (0x0014u) /* Handle of WriteVal characteristic declaration */
#define CY_BLE_NSTIM_WRITEVAL_CHAR_HANDLE   (0x0015u) /* Handle of WriteVal characteristic */
#define CY_BLE_NSTIM_WRITEVAL_CUSTOM_DESCRIPTOR_DESC_HANDLE   (0x0016u) /* Handle of Custom Descriptor descriptor */
#define CY_BLE_NSTIM_READSECOND_DECL_HANDLE   (0x0017u) /* Handle of ReadSecond characteristic declaration */
#define CY_BLE_NSTIM_READSECOND_CHAR_HANDLE   (0x0018u) /* Handle of ReadSecond characteristic */
#define CY_BLE_NSTIM_READSECOND_CUSTOM_DESCRIPTOR_DESC_HANDLE   (0x0019u) /* Handle of Custom Descriptor descriptor */
#define CY_BLE_NSTIM_NOTIFONE_DECL_HANDLE   (0x001Au) /* Handle of NotifOne characteristic declaration */
#define CY_BLE_NSTIM_NOTIFONE_CHAR_HANDLE   (0x001Bu) /* Handle of NotifOne characteristic */
#define CY_BLE_NSTIM_NOTIFONE_CUSTOM_DESCRIPTOR_DESC_HANDLE   (0x001Cu) /* Handle of Custom Descriptor descriptor */
#define CY_BLE_NSTIM_NOTIFONE_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_HANDLE   (0x001Du) /* Handle of Client Characteristic Configuration descriptor */
